...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'f22c8750-531d-11f1-a724-be152faedc42:1-16';
...
CREATE TABLE `Luggage` (
  ...
  `Price_per_kg` varchar(6) DEFAULT NULL
...
CREATE TABLE `Tickets` (
  ...
  `Seat_class` char(10) DEFAULT NULL,
  `Seat_price` int DEFAULT NULL,
  `Luggage_price` int DEFAULT NULL,
...
-- Dump completed on 2026-06-14  0:31:18
